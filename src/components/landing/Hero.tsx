...
const Hero = () => {
  ...
  return <section className="relative overflow-hidden">
      <div className="hero-section mx-4 mt-4 rounded-2xl border-0">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            duration: 0.6
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="relative flex items-center max-w-md bg-card rounded-full border-2 border-foreground shadow-[4px_4px_0_hsl(var(--foreground))] p-1.5 pl-5">
                  <input type="tel" placeholder="WhatsApp number" value={phoneNumber} onChange={e => setPhoneNumber(e.target.value)} className="flex-1 bg-transparent text-base outline-none placeholder:text-muted-foreground min-w-0" />
            ...
            delay: 0.2
              ...
              <div className="relative">
                <img src={heroIllustration} alt="Happy couple using Happy Duo on their phones" className="relative rounded-2xl border-3 border-foreground shadow-[8px_8px_0_hsl(var(--foreground))] max-w-full h-auto" style={{
                borderWidth: '3px'
              }} />
                
                {/* Floating badges */}
                <motion.div className="absolute -left-4 top-1/4 bg-card rounded-xl border-2 border-foreground shadow-[4px_4px_0_hsl(var(--foreground))] p-3" animate={{
                y: [0, -10, 0]
              }} transition={{
                duration: 4,
                repeat: Infinity,
                ...
                <motion.div className="absolute -right-4 bottom-1/4 bg-card rounded-xl border-2 border-foreground shadow-[4px_4px_0_hsl(var(--foreground))] p-3" animate={{
                y: [0, -10, 0]
              }} transition={{
                duration: 4,
                repeat: Infinity,
